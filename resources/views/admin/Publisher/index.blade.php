...
@section('content')
    ...
    <div class="container d-flex justify-content-between mb-3">
        ...
        <a href="{{ route('Publisher.create') }}" class="btn btn-success" title="Tambah Penerbit"><i class="bi bi-plus-square-fill fs-5"></i></a>
    </div>
            ...
            <tbody>
                ...
                @foreach ($data as $publisher)
                    <tr>
                        ...
                        <td>
                            <a href="{{ route('Publisher.edit', $publisher->id) }}" class="btn btn-warning btn-sm"><i
